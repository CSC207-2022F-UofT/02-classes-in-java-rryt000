...
public class Silly implements Comparable<Silly>{
    ...
    /** Creates a new Silly object.
     * This parameter takes in two strings as arguments.
     *
     * @param s1 is the first string.
     * @param s2 is the second string.
     * This Silly instance's name is the concatenation of s1 and s2.
     */
     ...
     *
     * @param other the Silly object to be compared.
